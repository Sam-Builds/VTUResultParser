...
def _infer_marks(nums: list):
    if not nums:
        return "", "", ""
    # Find first valid triple where a + b = c (CIE-only subjects can have internal > 60)
...
def _parse_subject_lines(text: str) -> list:
    ...
    for line in text.splitlines():
        ...
        # Strip date stamps (e.g. 2026-03-11) before extracting numbers
...
if __name__ == "__main__":
    ...
    all_data = parse_vtu_pdf(file_to_read)
